...
********************************************************************************/
	...
	****************************************************************************/
	...
	$agspay->SetValue("UserEmail",trim($_POST["UserEmail"])."@".trim($_POST["UserEmail2"]));	//주문자이메일
...
<form name=frmAGS_pay_ing method=post action="../page.php?cate=1&dep01=0&dep02=0&type=result&seq=2">
