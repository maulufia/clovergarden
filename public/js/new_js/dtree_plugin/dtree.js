...
function dTree(objName) {
    ...
    this.icon = {
        root                : '/images/point03.gif',    //  /images/tree/base.gif
        folder          : '/images/tree/folder.gif',
        folderOpen  : '/images/tree/folderopen.gif',
        node                : '/images/tree/page.gif',      //  /images/icon_01.gif
...
dTree.prototype.node = function(node, nodeId) {
    if(nodeId==0)
        var str = '<div class="firstNode">' + this.indent(node, nodeId);
    else
...
dTree.prototype.nodeStatus = function(status, id, bottom) {
    ...
    if(navigator.userAgent.indexOf("MSIE") != -1){
        var client_height   =    $('contentmenu').clientHeight - 18;
    }else{
        var client_height   =    $('contentmenu').clientHeight;
    }
    //$('sidemenu').style.height = client_height + 'px';
