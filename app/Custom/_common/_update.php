...
error_reporting(E_ALL & ~E_NOTICE & ~E_DEPRECATED); // 임시 에러 없앰.

$DB_Connect = mysql_connect("localhost","clovergarden","clovergarden12*!");
...
$query = "select user_id from new_tb_member where order_cencle != 'n' and user_id != 'master@clovergarden.co.kr' order by id desc";
