<?php
    ...
    class OnetooneClass
    {
        ...
        function OnetooneClass()
        {
            $this->table_name = 'new_tb_onetoone';
            $this->sub_sql    = '';
        ...
        function ArrList($pResult, $pCnt, $pJoin=null)
        {
			...
			$pResultValue[$pCnt]->receive       = stripcslashes($pResult['receive']);
        ...
        function VarList($pResult, $pCnt=0, $pJoin=null)
        {
			...
			$this->receive       = $pResult[$pCnt]->receive;
        ...
        function ArrOnetoone($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
                    ...
                    break;
				case 'receive' :
                    $SelectField = array('이메일','전화');
                    $SelectValue = array('0','1');
                    break;
            }
            if($pWrite == ''){
