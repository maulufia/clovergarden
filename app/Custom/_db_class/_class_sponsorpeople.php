<?php
    settype($nSponsorpeople, 'object');

    class SponsorpeopleClass
    {
        var $seq;               //고유번호
		var $file_real;
        var $file_edit;
        ...
        function SponsorpeopleClass()
        {
            $this->table_name = 'new_tb_sponsorpeople';
            $this->sub_sql    = '';
        ...
        function ArrSponsorpeople($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
