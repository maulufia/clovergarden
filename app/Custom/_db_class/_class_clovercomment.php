<?php
    settype($nClovercomment, 'object');

    class ClovercommentClass
    {
        var $seq;               //고유번호
		var $clover_seq;			//클로버아이디
		var $writer;			//작성자
        var $subject;				//제목
        var $hit;               //조회수
        var $reg_date;          //등록일
        ...
        function ClovercommentClass()
        {
            $this->table_name = 'new_tb_clovercomment';
            $this->sub_sql    = '';
        ...
        function ArrClovercomment($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
