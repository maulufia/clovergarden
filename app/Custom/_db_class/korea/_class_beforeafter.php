<?php
    ...
    class BeforeAfterClass
    {
        ...
        function BeforeAfterClass()
        {
            $this->table_name = 'new_tb_kor_beforeafter';
            $this->sub_sql    = '';
            $this->page_view  = 6;
        ...
        */
        ...
        function ArrList($pResult, $pCnt, $pJoin=null)
        {
			...
			$pResultValue[$pCnt]->media_seq       = stripcslashes($pResult['media_seq']);
			$pResultValue[$pCnt]->real_seq       = stripcslashes($pResult['real_seq']);
        ...
        function VarList($pResult, $pCnt=0, $pJoin=null)
        {
			...
			$this->media_seq       = $pResult[$pCnt]->media_seq;
			$this->real_seq       = $pResult[$pCnt]->real_seq;
        ...
        function ArrBeforeAfter($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
