<?php
    ...
    class SelfClass
    {
        ...
        function SelfClass()
        {
            $this->table_name = 'new_tb_kor_self';
            $this->sub_sql    = '';
            $this->page_view  = 9;
        ...
        */
        ...
        function ArrList($pResult, $pCnt, $pJoin=null)
        {
			...
			$pResultValue[$pCnt]->surgery       = stripcslashes($pResult['surgery']);
        ...
        function VarList($pResult, $pCnt=0, $pJoin=null)
        {
			...
			$this->surgery       = $pResult[$pCnt]->surgery;
        ...
        function ArrSelf($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
