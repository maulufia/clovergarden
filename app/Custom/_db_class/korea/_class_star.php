<?php
    ...
    class StarClass
    {
        ...
        function StarClass()
        {
            $this->table_name = 'new_tb_kor_star';
            $this->sub_sql    = '';
        ...
        */
        ...
        function ArrList($pResult, $pCnt, $pJoin=null)
        {
            ...
            $pResultValue[$pCnt]->job    = stripcslashes($pResult['job']);
        ...
        function ArrStar($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
