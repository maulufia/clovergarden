<?php
    settype($nAftercounsel, 'object');

    class AftercounselClass
    {
        var $seq;               //고유번호
		var $writer;				//작성자
        var $name;				//이름
        ...
        function AftercounselClass()
        {
            $this->table_name = 'new_tb_kor_aftercounsel';
            $this->sub_sql    = '';
        ...
        */
        ...
        function ArrAftercounsel($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
