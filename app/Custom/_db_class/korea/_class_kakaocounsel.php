<?php
    settype($nKakaocounsel, 'object');

    class KakaocounselClass
    {
        var $seq;               //고유번호
        ...
        function KakaocounselClass()
        {
            $this->table_name = 'new_tb_kor_kakaocounsel';
            $this->sub_sql    = '';
        ...
        */
        ...
        function ArrKakaocounsel($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
