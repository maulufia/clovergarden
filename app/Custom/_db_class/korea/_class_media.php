<?php
    ...
    class MediaClass
    {
        ...
        function MediaClass()
        {
            $this->table_name = 'new_tb_kor_media';
            $this->sub_sql    = '';
        ...
        */
        ...
        function ArrList($pResult, $pCnt, $pJoin=null)
        {
            ...
            $pResultValue[$pCnt]->youtube_seq    = stripcslashes($pResult['youtube_seq']);
			$pResultValue[$pCnt]->youtube    = stripcslashes($pResult['youtube']);
        ...
        function VarList($pResult, $pCnt=0, $pJoin=null)
        {
            ...
            $this->youtube_seq    = $pResult[$pCnt]->youtube_seq;
			$this->youtube    = $pResult[$pCnt]->youtube;
        ...
        function ArrMedia($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
