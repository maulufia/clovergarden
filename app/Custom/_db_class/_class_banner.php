<?php
    ...
    class BannerClass
    {
        ...
        function ArrList($pResult, $pCnt, $pJoin=null)
        {
            ...
            $pResultValue[$pCnt]->content    = isset($pResult['content']) ? stripcslashes($pResult['content']) : '';
        ...
        function ArrBanner($pVal, $pName, $pOption, $pKind, $pWrite='')
        {
            switch($pKind)
            {
                case 'search' :
