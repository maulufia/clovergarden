<?php
	...
	$nAftercounsel->answer        = RepEditor($_POST['answer']);

	$nAftercounsel->reserve = $_POST['reserve'];
...
$Conn = new DBClass();
    ...
    $Conn->StartTrans();
    $out_put = $Conn->UpdateDB($nAftercounsel->table_name, $arr_field, $arr_value, "where seq = '".$seq."'");
	if(in_array(3,$nAftercounsel->reserve)){
	   /******************** 인증정보 ********************/
	...
	if(in_array(2,$nAftercounsel->reserve)){
