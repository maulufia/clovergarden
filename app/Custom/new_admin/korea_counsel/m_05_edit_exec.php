<?php
	...
	$nPhotocounsel->answer        = RepEditor($_POST['answer']);

	$nPhotocounsel->reserve = $_POST['reserve'];
...
$Conn = new DBClass();
    ...
    $Conn->StartTrans();
    $out_put = $Conn->UpdateDB($nPhotocounsel->table_name, $arr_field, $arr_value, "where seq = '".$seq."'");
	if(in_array(2,$nPhotocounsel->reserve)){
	   /******************** 인증정보 ********************/
	...
	if(in_array(1,$nPhotocounsel->reserve)){
