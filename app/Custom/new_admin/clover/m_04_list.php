...
$Conn = new DBClass();
	...
	$nClovermlist->where = " where type=0";
    ...
    <div id="container">
        ...
        <div id="right_area">
            ...
            <div class="bbs-search" style="margin-bottom:0px;">
				...
				<a href="javascript:alert('준비중입니다.');" style="padding:0 10px; background:#fff; height:20px; line-height:20px; float:right; border:1px solid #dbdbdb; margin-right:10px;">더빌양식 다운로드</a>
            </div>
