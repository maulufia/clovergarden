        ...
        <div id="right_area">
            ...
            <table class="bbs-write">
				...
				<tr>
					...
					<th>구분</th>
                    <td>
						<?$nClover->ArrClover($nClover->category, "name='category'", null, 'category')?>
                    </td>
                </tr> 
				<tr>
                    <th>고유코드</th>
				...
				<tr>
                    ...
                    <td colspan="3">
						<select name="hot">
							<option value="1" <?if($nClover->hot == 1){?>selected<?}?>>1도
							<option value="2" <?if($nClover->hot == 2){?>selected<?}?>>2도
							<option value="3" <?if($nClover->hot == 3){?>selected<?}?>>3도
						</select>
                    </td>
                </tr>
