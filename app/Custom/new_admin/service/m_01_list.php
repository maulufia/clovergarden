        ...
        <div id="right_area">
            ...
            <div class="bbs-search" style="margin-bottom:0px;">
                <form name="frm" method="post" action="<?=$list_link?>" style="display:inline">
                    <?$nSchedule->ArrSchedule(null, "name='search_key'", null, 'search')?>
								...
								<tr>
									...
									<?php
										if(FileExists('../../up_file/schedule/'.$nSchedule->file_edit[1])){
											echo "<img src='/up_file/schedule/".$nSchedule->file_edit[1]."' border='0' width='130'>";                  
										}else{
											echo "<img src='/common/img/no-image.jpg' alt='no image' width='130'>"; 
										}
									?>
									</td>
									<td class="subject">
										<a href="javascript:pageLink('<?=$nSchedule->seq?>','<?=$row_no?>','view','<?=$view_link?>');"><?=$nSchedule->subject?> (<?=$nSchedule->start_date?>)</a>
									</td>
