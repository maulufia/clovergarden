              ...
              <tr>
                ...
                <td colspan="3">
                  <select name="hot">
                    ...
                    <tr>
                      <th>[모바일]<br />썸네일이미지</th>
                      <td colspan="3"><input type="file" name="mobile_thumbnail" size="50" /></td>
                    </tr>

                    <tr>
                      <th>[모바일]<br />상단 이미지</th>
                      <td colspan="3"><input type="file" name="mobile_image1" size="50" /></td>
                    </tr>

                    <tr>
                      <th>[모바일]<br />내용 이미지 1</th>
                      <td colspan="3"><input type="file" name="mobile_image2" size="50" /></td>
                    </tr>

                    <tr>
                      <th>[모바일]<br />내용 이미지 2</th>
                      <td colspan="3"><input type="file" name="mobile_image3" size="50" /></td>
                    </tr>

                    <tr>
                      <th>[모바일]<br />소개글</th>
                      <td colspan="3"><textarea name="mobile_intro"></textarea></td>
                    </tr>
