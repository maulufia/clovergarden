    ...
    <div id="container">
        ...
        <div id="right_area">
            ...
            <table class="bbs-list">
				...
				?>
								<tr>
									...
									<td>{{ $row_no }}</td>
									<td class="subject">
										<a href="{{ route('admin/community', array('item' => 'board_sponsor', 'seq' => $nFree->seq, 'row_no' => $row_no, 'type' => 'view')) }}">{{ $nFree->subject }}</a>
									</td>
									<td>{{ $nFree->writer }}</td>
									<td>{{ $nFree->hit }}</td>
            ...
            <div class="btn-area tmargin">
                ...
                <div class="fright">
                    <a href="javascript:pageLink('','','','{{ $write_link }}');"><img src="/imgs/admin/images/btn_write.gif" alt="writing" /></a>
                </div>
            </div>
        </div>
        <!-- //right_area -->
