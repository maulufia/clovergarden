...
<?php
  ...
  if($u_mode == "update"){
     if(is_uploaded_file($_FILES['use_com']['tmp_name'])) {
          /*
               파일 업로드 함수
          */
          ...
          */
          $upload_return = file_upload($_FILES['use_com'], '/home/clovergarden/cg_app/public/imgs/page/', 'gif,GIF,jpg,JPG,jpeg,JPEG,png,PNG', time());
...
/* 파일 업로드가 진행중이 아닐때 */
	...
	$sql = "update new_tb_adm_tup set t_text='".$upload_return."' where t_name='use_com'";
	mysql_query($sql);
...
<div id="wrapper">
    ...
    <div id="container">
      ...
      <input type="hidden" name="_token" value="{{ csrf_token() }}" />
			...
			<tr height=30><td><input type="file" name="use_com" value="" size="60"></td></tr>
			<tr>
