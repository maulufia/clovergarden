...
<?php
  ...
  if($u_mode == "update"){
     if(is_uploaded_file($_FILES['use_inm']['tmp_name'])) {
          /*
               파일 업로드 함수
          */
          ...
          */
          $upload_return = file_upload($_FILES['use_inm'], '/home/clovergarden/cg_app/public/imgs/page/', 'gif,GIF,jpg,JPG,jpeg,JPEG,png,PNG', time());
...
/* 파일 업로드가 진행중이 아닐때 */
	...
	$sql = "update new_tb_adm_tup set t_text='".$upload_return."' where t_name='use_inm'";
	mysql_query($sql);
...
<div id="wrapper">
    ...
    <div id="container">
      ...
      <input type="hidden" name="_token" value="{{ csrf_token() }}" />
			...
			<tr height=30><td><input type="file" name="use_inm" value="" size="60"></td></tr>
			<tr>
