		...
		<ul class="depth last">
			...
			<li>
				<ul>
					...
					<li><a href="{{ route('mypage', array('cate' => 6, 'dep01' => 0)) }}">포인트조회</a></li>
					<li><a href="{{ route('mypage', array('cate' => 6, 'dep01' => 1)) }}">나의활동</a></li>
					<!--<li><a href="{{ route('mypage', array('cate' => 6, 'dep01' => 3)) }}">공제센터</a></li>-->
					<li><a href="{{ route('mypage', array('cate' => 6, 'dep01' => 3)) }}">개인정보수정</a></li>
					<li><a href="{{ route('mypage', array('cate' => 6, 'dep01' => 4)) }}">결제정보수정</a></li>
				</ul>
			</li>
		</ul>
