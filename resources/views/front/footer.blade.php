	<script type="text/javascript" src="/common/js/jquery.imageScroller.js"></script>
	<style type="text/css">
	...
	ul#scrollerFrame li img { width:<?=$img_width?>px; height:<?=$img_height?>px; }			
	</style>
	...
	<div class="prtner_scroll">
		<div class="partner"><img src="/common/img/CloverGardenPartner.png" alt="CloverGardenPartner" /></div>
		
		<div class="scroll">
			<div id="scroller">
				<div class="title">
					<span id="btn1" style="float:left;"><img src="/common/img/banner_arrow_l.png"></span>
					<span id="btn2" style="float:right;"><img src="/common/img/banner_arrow_r.png"></span>
				</div>
							...
							<a href="http://<?=$nBanner->url?>" target="_blank">					
								<?php
									if(FileExists('./up_file/banner/'.$nBanner->file_edit[1])){
										echo "<img src='/up_file/banner/".$nBanner->file_edit[1]."' border='0' style='width: 100px;'>";                  
									}
								?>
							</a>
						</li>
    ...
    <footer id="site-footer">
        <div class="wrap">
            <!-- Footer Logo -->
            <div id="footer_logo">
                <img src="/common/img/BottomLogo.png" alt="clover garden" />
            </div>
